...
function MultiPatientCard({
    ...
    return (
        ...
        >
            <div className="multi-patient-card">
                                ...
                                {selectedData && (
                                    <div className="vitals-summary pt-3 border-top" style={{ borderColor: 'var(--border-color) !important' }}>
                                        <div className="row g-2">
                                            <div className="col-4">
                                                <div className="vital-box text-center p-2 rounded" style={{ backgroundColor: 'var(--bg-input)', border: '1px solid var(--border-color)' }}>
                ...
                <style>{`
                    ...
                    .multi-patient-card button:focus-visible {
